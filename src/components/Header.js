    ...
    return(
      <header>
        ...
        <div className="sub-info-container">
          <p className="sub-text">{user.folllowers.length} followers<a href={user.link}>{user.link.replace("https://in"," ")}</a></p>

        </div>
        <button className="primary" onClick={()=>{navigator.clipboard.writeText("IAM A URL")}} >Share Profile</button>
